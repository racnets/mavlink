 ...
 */
static inline uint16_t mavlink_msg_huch_altitude_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, int16_t baro, int16_t baroref)
{
	uint16_t i = 0;
...
static inline uint16_t mavlink_msg_huch_altitude_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, int16_t baro, int16_t baroref)
{
	uint16_t i = 0;
	msg->msgid = MAVLINK_MSG_ID_HUCH_ALTITUDE;
...
static inline void mavlink_msg_huch_altitude_send(mavlink_channel_t chan, int16_t baro, int16_t baroref)
{
	mavlink_message_t msg;
	mavlink_msg_huch_altitude_pack_chan(mavlink_system.sysid, mavlink_system.compid, chan, &msg, baro, baroref);
 ...
 * @return 
 */
static inline int16_t mavlink_msg_huch_altitude_get_baro(const mavlink_message_t* msg)
{
	generic_16bit r;
	r.b[1] = (msg->payload)[0];
	r.b[0] = (msg->payload)[1];
