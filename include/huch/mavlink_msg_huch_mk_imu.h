...
static inline uint16_t mavlink_msg_huch_mk_imu_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro)
{
	uint16_t i = 0;
	msg->msgid = MAVLINK_MSG_ID_HUCH_MK_IMU;
...
static inline void mavlink_msg_huch_mk_imu_send(mavlink_channel_t chan, int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro)
{
	...
	mavlink_msg_huch_mk_imu_pack_chan(mavlink_system.sysid, mavlink_system.compid, chan, &msg, xacc, yacc, zacc, xgyro, ygyro, zgyro);
