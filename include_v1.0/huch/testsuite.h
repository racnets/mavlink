...
static void mavlink_test_huch_quad_pix_raw(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_huch_quad_pix_raw_t packet_in = {
		963497464,
	{ 963497672, 963497673, 963497674, 963497675, 963497676, 963497677, 963497678, 963497679, 963497680, 963497681 },
	};
	mavlink_huch_quad_pix_raw_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.msec = packet_in.msec;
        
        	mav_array_memcpy(packet1.data, packet_in.data, sizeof(uint32_t)*10);
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_quad_pix_raw_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_huch_quad_pix_raw_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_quad_pix_raw_pack(system_id, component_id, &msg , packet1.msec , packet1.data );
	mavlink_msg_huch_quad_pix_raw_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_quad_pix_raw_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.msec , packet1.data );
	mavlink_msg_huch_quad_pix_raw_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_huch_quad_pix_raw_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_huch_quad_pix_raw_send(MAVLINK_COMM_1 , packet1.msec , packet1.data );
	mavlink_msg_huch_quad_pix_raw_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_huch(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_huch_quad_pix_raw(system_id, component_id, last_msg);
